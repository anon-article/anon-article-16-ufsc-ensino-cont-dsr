# Parte do projeto Anonymous Author © 2025 Anonymous Author
...
CABECALHO_LICENCA = {
    ...
    "titulo": "Banco de Questões Comentadas - Anonymous Author",
    "autor": "Comunidade do Anonymous Author",
    "fonte": "https://github.com/Anonymous Author/Anonymous Author", 
    ...
    "aviso_legal": "As questões de exames e concursos públicos são de acesso público e pertencem às suas respectivas bancas organizadoras (como CFC, FGV, Consulplan, entre outras), não sendo de propriedade deste projeto. Este projeto utiliza tais questões exclusivamente para fins educacionais. As resoluções, lançamentos contábeis, comentários, explicações, compilações e a organização dos dados constituem criações originais da Comunidade do Anonymous Author e são disponibilizadas sob a licença Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)."
}
