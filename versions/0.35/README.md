...
# ⚖️ Anonymous Author - Plataforma de Estudos Contábeis

> **Democratizando o acesso ao conhecimento contábil com tecnologia aberta.**

O **Anonymous Author** é uma plataforma projetada para centralizar, organizar e facilitar o estudo para o Exame de Suficiência do CFC.


🔗 **[Acesse a versão online aqui](https://Anonymous Author.github.io/Anonymous Author/)**
...
O Anonymous Author possui uma ferramenta de ingestão de dados:
...
1.  Abra o arquivo `tools/generator.html` no seu navegador, ou acesse [Gerador de questões](https://Anonymous Author.github.io/Anonymous Author/tools/generator.html)
...
Isso garante que o Anonymous Author (e qualquer derivado dele) permaneça livre e aberto para sempre. Veja o arquivo [LICENSE](LICENSE) para mais detalhes da licença de software. Veja [LICENSE_CONTENT](LICENSE_CONTENT) para a licença de conteúdo.

-----

*Desenvolvido inicialmente por [Anonymous Author] e otimizado com o auxílo de IA. Sem afiliação com o CFC.*
